...
merge m:m country  using "Data_Intergenerational_mobility_north_America.dta"
keep if _merge==3
drop _merge
...
spineplot edattain EEE2 if Continents==3 , ///
...
graph export "${graphs_path}/transition_new_North_America.png",replace
